...
data class BottlesChapter6(
    ...
    fun verse(bottleNumber: Int): String {
        val aBottleNumber = BottleNumberChapter6(bottleNumber)
        val aBottleSuccessorNumber = BottleNumberChapter6(aBottleNumber.getSuccessor(maxBottles))
 ...
 */
data class BottleNumberChapter6(
